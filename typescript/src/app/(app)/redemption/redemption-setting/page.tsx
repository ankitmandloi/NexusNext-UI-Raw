...
import { initialRedemptionSettings, customerTypes, statusOptions, RedemptionSetting } from './data'

const ITEMS_PER_PAGE = 10

export default function RedemptionSettingPage() {
  const [settings, setSettings] = useState<RedemptionSetting[]>(initialRedemptionSettings)
  const [activeModal, setActiveModal] = useState<string | null>(null)
  const [selectedSetting, setSelectedSetting] = useState<RedemptionSetting | null>(null)
  ...
  const openModal = (type: string, payload?: RedemptionSetting) => {
    setActiveModal(type)
  ...
  const handleAddSetting = () => {
    ...
    const newSetting: RedemptionSetting = {
