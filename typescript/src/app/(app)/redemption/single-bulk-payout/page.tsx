...
export default function SingleBulkPayoutPage() {
  const [payouts, setPayouts] = useState<SingleBulkPayout[]>(initialSingleBulkPayouts)
  const [activeModal, setActiveModal] = useState<string | null>(null)
  const [selectedPayout, setSelectedPayout] = useState<SingleBulkPayout | null>(null)
  ...
  const openModal = (type: string, payload?: SingleBulkPayout) => {
    setActiveModal(type)
  ...
  const handleAddPayout = () => {
    ...
    const newPayout: SingleBulkPayout = {
