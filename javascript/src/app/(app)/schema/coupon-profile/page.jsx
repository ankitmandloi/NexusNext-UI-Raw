...
export default function CouponProfilePage() {
  ...
  const [profiles, setProfiles] = useState(initialCouponProfiles)
  ...
  const handleGenerateCoupon = (profile) => {
    router.push(`/schema/coupon-profile/generate-coupon?profileId=${profile.id}&profileName=${encodeURIComponent(profile.couponProfileName)}`)
  }
    ...
    <div className="flex flex-col" style={{ height: 'calc(100vh - 110px)' }}>
      ...
      <CommonTable
        ...
        columns={[
          ...
          { key: 'couponProfileName', label: 'Coupon Profile Name', width: '220px' },
          { key: 'couponPattern', label: 'Coupon Pattern', width: '160px' },
          { key: 'couponLength', label: 'Coupon Length', width: '140px' },
          { key: 'excludingCharacter', label: 'Excluding Character', width: '180px' },
          { key: 'customerTypeRequired', label: 'Customer Type Required', width: '200px' },
